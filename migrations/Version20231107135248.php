 ...
 */
final class Version20231107135248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (user_id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, address VARCHAR(50) NOT NULL, telephone VARCHAR(50) NOT NULL, roles TINYTEXT NOT NULL COMMENT \'(DC2Type:array)\', password VARCHAR(50) NOT NULL, createdAt VARCHAR(50) NOT NULL, updatedAt VARCHAR(50) NOT NULL, UNIQUE INDEX email (email), PRIMARY KEY(user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
